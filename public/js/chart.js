...
(function (global, factory) {
  ...
  function buildStacks(layouts) {
    ...
    var _iterator12 = _createForOfIteratorHelper(layouts),
        _step12;

    try {
      for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
        var wrap = _step12.value;
  ...
  function placeBoxes(boxes, chartArea, params, stacks) {
    ...
    var _iterator13 = _createForOfIteratorHelper(boxes),
        _step13;
  ...
  function nodeListContains(nodeList, canvas) {
    var _iterator14 = _createForOfIteratorHelper(nodeList),
        _step14;
    ...
    _createClass(Animations, [{
      ...
      value: function configure(config) {
        ...
        Object.getOwnPropertyNames(config).forEach(function (key) {
          ...
          var _iterator17 = _createForOfIteratorHelper(animationOptions),
              _step17;
  ...
  function getLastIndexInStack(stack, vScale, positive, type) {
    var _iterator18 = _createForOfIteratorHelper(vScale.getMatchingVisibleMetas(type).reverse()),
        _step18;

    try {
      for (_iterator18.s(); !(_step18 = _iterator18.n()).done;) {
        var meta = _step18.value;
  ...
  function updateStacks(controller, parsed) {
    ...
    for (var i = 0; i < ilen; ++i) {
      var item = parsed[i];
      var _index2 = item[iAxis],
          value = item[vAxis];
      var itemStacks = item._stacks || (item._stacks = {});
      stack = itemStacks[vAxis] = getOrCreateStack(stacks, key, _index2);
  ...
  var DatasetController = /*#__PURE__*/function () {
    ...
    _createClass(DatasetController, [{
      ...
      value: function _resyncElements(resetNewElements) {
        ...
        var _iterator20 = _createForOfIteratorHelper(this._syncList),
            _step20;

        try {
          for (_iterator20.s(); !(_step20 = _iterator20.n()).done;) {
            var _step20$value = _slicedToArray(_step20.value, 3),
                method = _step20$value[0],
                arg1 = _step20$value[1],
                arg2 = _step20$value[2];
  ...
  function createDescriptors(chart, _ref2, options, all) {
    ...
    var _iterator22 = _createForOfIteratorHelper(plugins),
        _step22;
  ...
  function needContext(proxy, names) {
    ...
    var _iterator24 = _createForOfIteratorHelper(names),
        _step24;
  ...
  var Chart = /*#__PURE__*/function () {
    ...
    _createClass(Chart, [{
      ...
      value: function _updateHiddenIndices() {
        ...
        var _iterator25 = _createForOfIteratorHelper(changes),
            _step25;

        try {
          for (_iterator25.s(); !(_step25 = _iterator25.n()).done;) {
            var _step25$value = _step25.value,
                method = _step25$value.method,
                start = _step25$value.start,
                count = _step25$value.count;
  ...
  function setInflateAmount(properties, _ref5, ratio) {
    var inflateAmount = _ref5.inflateAmount;
  ...
  var BarController = /*#__PURE__*/function (_DatasetController) {
    ...
    _createClass(BarController, [{
      ...
      value: function _getStacks(last, dataIndex) {
        ...
        var _iterator26 = _createForOfIteratorHelper(metasets),
            _step26;

        try {
          for (_iterator26.s(); !(_step26 = _iterator26.n()).done;) {
            var meta = _step26.value;
  ...
  var BubbleController = /*#__PURE__*/function (_DatasetController2) {
    ...
    _createClass(BubbleController, [{
      ...
      key: "parsePrimitiveData",
      value: function parsePrimitiveData(meta, data, start, count) {
        var parsed = _get2(_getPrototypeOf(BubbleController.prototype), "parsePrimitiveData", this).call(this, meta, data, start, count);
      ...
      key: "parseArrayData",
      value: function parseArrayData(meta, data, start, count) {
        var parsed = _get2(_getPrototypeOf(BubbleController.prototype), "parseArrayData", this).call(this, meta, data, start, count);
      ...
      key: "parseObjectData",
      value: function parseObjectData(meta, data, start, count) {
        var parsed = _get2(_getPrototypeOf(BubbleController.prototype), "parseObjectData", this).call(this, meta, data, start, count);
        ...
        if (this._parsing === false) {
          ...
          if (isObject(data[start])) {
            var _this$_parsing$key2 = this._parsing.key,
                key = _this$_parsing$key2 === void 0 ? 'value' : _this$_parsing$key2;
    ...
    _createClass(PolarAreaController, [{
      ...
      value: function getMinMax() {
        ...
        meta.data.forEach(function (element, index) {
          var parsed = _this21.getParsed(index).r;

          if (!isNaN(parsed) && _this21.chart.getDataVisibility(index)) {
            if (parsed < range.min) {
              range.min = parsed;
            }
      ...
      value: function countVisibleElements() {
        ...
        var count = 0;
        meta.data.forEach(function (element, index) {
          if (!isNaN(_this22.getParsed(index).r) && _this22.chart.getDataVisibility(index)) {
            count++;
          }
        });
        return count;
  ...
  var ScatterController = /*#__PURE__*/function (_DatasetController7) {
    ...
    _createClass(ScatterController, [{
      ...
      value: function addElements() {
        ...
        _get2(_getPrototypeOf(ScatterController.prototype), "addElements", this).call(this);
      }
    }, {
      key: "updateElements",
      value: function updateElements(points, start, count, mode) {
        ...
        var _this$options11 = this.options,
            spanGaps = _this$options11.spanGaps,
            segment = _this$options11.segment;
        var maxGapLength = isNumber(spanGaps) ? spanGaps : Number.POSITIVE_INFINITY;
        var directUpdate = this.chart._animationsDisabled || reset || mode === 'none';
        var prevParsed = start > 0 && this.getParsed(start - 1);
  ...
  function strokePathDirect(ctx, line, start, count) {
    ...
    var _iterator27 = _createForOfIteratorHelper(segments),
        _step27;

    try {
      for (_iterator27.s(); !(_step27 = _iterator27.n()).done;) {
        var segment = _step27.value;
  ...
  function _segments(line, target, property) {
    ...
    try {
      for (_iterator29.s(); !(_step29 = _iterator29.n()).done;) {
        ...
        var _iterator30 = _createForOfIteratorHelper(targetSegments),
            _step30;

        try {
          for (_iterator30.s(); !(_step30 = _iterator30.n()).done;) {
            var tgt = _step30.value;

            var subBounds = _getBounds(property, tpoints[tgt.start], tpoints[tgt.end], tgt.loop);

            var fillSources = _boundSegment(segment, points, subBounds);

            var _iterator31 = _createForOfIteratorHelper(fillSources),
                _step31;

            try {
              for (_iterator31.s(); !(_step31 = _iterator31.n()).done;) {
                var fillSource = _step31.value;
                parts.push({
                  source: fillSource,
                  target: tgt,
  ...
  function clipVertical(ctx, target, clipY) {
    ...
    var _iterator32 = _createForOfIteratorHelper(segments),
        _step32;

    try {
      for (_iterator32.s(); !(_step32 = _iterator32.n()).done;) {
        var segment = _step32.value;
        var start = segment.start,
            end = segment.end;
    ...
    try {
      for (_iterator33.s(); !(_step33 = _iterator33.n()).done;) {
        var _step33$value = _step33.value,
            src = _step33$value.source,
            tgt = _step33$value.target,
            start = _step33$value.start,
            end = _step33$value.end;
    ...
    _createClass(Legend, [{
      ...
      value: function adjustHitBoxes() {
        ...
        if (this.isHorizontal()) {
          ...
          var _iterator34 = _createForOfIteratorHelper(hitboxes),
              _step34;

          try {
            for (_iterator34.s(); !(_step34 = _iterator34.n()).done;) {
              var hitbox = _step34.value;
          ...
          var _iterator35 = _createForOfIteratorHelper(hitboxes),
              _step35;

          try {
            for (_iterator35.s(); !(_step35 = _iterator35.n()).done;) {
              var _hitbox = _step35.value;
  ...
  var Tooltip = /*#__PURE__*/function (_Element8) {
    ...
    _createClass(Tooltip, [{
      ...
      value: function setActiveElements(activeElements, eventPosition) {
        ...
        var lastActive = this._active;
        var active = activeElements.map(function (_ref12) {
          var datasetIndex = _ref12.datasetIndex,
              index = _ref12.index;
    ...
    _createClass(CategoryScale, [{
      ...
      value: function init(scaleOptions) {
        ...
        if (added.length) {
          ...
          var _iterator36 = _createForOfIteratorHelper(added),
              _step36;

          try {
            for (_iterator36.s(); !(_step36 = _iterator36.n()).done;) {
              var _step36$value = _step36.value,
                  _index3 = _step36$value.index,
                  label = _step36$value.label;
        ...
        _get2(_getPrototypeOf(CategoryScale.prototype), "init", this).call(this, scaleOptions);
      }
    }, {
      key: "parse",
      value: function parse(raw, index) {
  ...
  function relativeLabelSize(value, minSpacing, _ref13) {
    var horizontal = _ref13.horizontal,
        minRotation = _ref13.minRotation;
...
module.exports = __webpack_require__(/*! C:\Users\Dogana\Boolean Project\laravel-projects\bdoctors_project\resources\js\chart.js */"./resources/js/chart.js");
